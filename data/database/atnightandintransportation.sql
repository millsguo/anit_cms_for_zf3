...
--
-- Base de données :  `atnightandintransportation`
--
...
(21, 2, 'Keep in touch', '', 11, '<div class=\"col-lg-8\">\r\n<p>Hac ex causa conlaticia stipe Valerius humatur ille Publicola et subsidiis amicorum mariti inops cum liberis uxor alitur Reguli et dotatur ex aerario filia Scipionis, cum nobilitas florem adultae virginis diuturnum absentia pauperis erubesceret patris.</p>\r\n<p>Restabat ut Caesar post haec properaret accitus et abstergendae causa suspicionis sororem suam, eius uxorem, Constantius ad se tandem desideratam venire multis fictisque blanditiis hortabatur. quae licet ambigeret metuens saepe cruentum, spe tamen quod eum lenire poterit ut germanum profecta, cum Bithyniam introisset, in statione quae Caenos Gallicanos appellatur, absumpta est vi febrium repentina. cuius post obitum maritus contemplans cecidisse fiduciam qua se fultum existimabat, anxia cogitatione, quid moliretur haerebat.</p>\r\n</div>\r\n<div class=\"col-lg-4\"><img class=\"img-responsive\" src=\"../../filesbank/cool-meeting.jpg\" alt=\"\" /></div>', NULL, NULL, 'content', '', '', '2018-11-07 17:14:07', '', '', '', 0, 0, 'null'),
...
(83, 2, 'Body text', 'Lorem ipsum', 34, '<p>Bla bla bla.</p>\r\n<p>Lorem ipsum.</p>', NULL, NULL, 'content', '', '', '2018-09-28 16:50:10', '', '', '', 0, 0, 'null'),
...
--
-- Déchargement des données de la table `filesupload`
--
...
--
-- Déchargement des données de la table `linktocontenu`
--

INSERT INTO `linktocontenu` (`linktocontenu_id`, `contenu_id`, `rang`, `titre`, `soustitre`, `sousrubriques_id`, `contenuhtml`, `image`, `image2`, `type`, `author`, `themes`, `othertext1`, `othertext2`, `othertext3`, `gps_coordinates`, `linktosousrubrique_id`, `linktorubrique_id`, `contenu_date`) VALUES
(4, 50, 1, 'CMS', 'I mean let\'s try it. Go !', 19, '<div>Why you should use my cms :-) September 09, 2015 Romuald GEBLEUX 10000000 Comments Php, Zend, cms At vero eos et accusamus et iusto odio dignissimo...</div>', 'filesbank/cms.jpg', '', 'linktocontenu', NULL, NULL, NULL, NULL, NULL, NULL, 29, 14, '2018-06-11 16:39:43');
...
INSERT INTO `message` (`message_id`, `message_msg`, `message_row1`, `message_row2`, `message_row3`, `message_row4`, `message_position`, `message_type`, `message_date`) VALUES
(4, 'fdgdsfgsd', 'testMsg', 'test2', 'test@test.test', 'test', 0, 'blog', '2018-11-07 17:27:34');
...
(14, 'One Page', 1, 'public', -1, 'index.phtml', 0, 0, 0, 0, 1),
(15, 'Blog', 2, 'public', -1, 'blog.phtml', 0, 1, 0, 0, 1),
(42, 'first page for testing the extranet', 1, 'private', 3, 'test_private_site.phtml', 1, 0, 0, 0, 1),
(43, 'Update contact information', 2, 'private', 3, 'updatecontactinformation.phtml', 0, 0, 1, 0, 1),
(44, 'Private Blog 2', 3, 'private', 3, 'test_private_blog.phtml', 0, 1, 0, 0, 1),
(46, 'extranet upload file test', 4, 'private', 3, 'test_extranet_upload_file.phtml', 0, 0, 0, 1, 1);
